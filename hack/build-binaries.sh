...
GOOS=linux GOARCH=arm64 go build -ldflags="$LDFLAGS" -trimpath -o kbld-linux-arm64 ./cmd/kbld/...
GOOS=windows GOARCH=amd64 go build -ldflags="$LDFLAGS" -trimpath -o kbld-windows-amd64.exe ./cmd/kbld/...
GOOS=windows GOARCH=arm64 go build -ldflags="$LDFLAGS" -trimpath -o kbld-windows-arm64.exe ./cmd/kbld/...
